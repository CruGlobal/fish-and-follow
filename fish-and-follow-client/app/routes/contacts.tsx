...
export default function Contacts() {
  ...
  // Use real contact stats from database
  const { 
    stats: dbStats, 
  ...
  // Use database stats for the statistics cards, fallback to filtered stats if not available
  const stats = dbStats || {
