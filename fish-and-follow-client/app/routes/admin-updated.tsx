      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
          ...
          <StatCard
            ...
            icon={
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" style={{ color: 'var(--brand-primary)' }}>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              >
                ...
                <div className="ml-4">
                  <h4 className="text-sm font-semibold text-gray-800">Export Contacts</h4>
                  <p className="text-xs text-gray-600 mt-1">Download contact data</p>
                </div>
              </button>
              ...
              >
                ...
                <div className="ml-4">
                  <h4 className="text-sm font-semibold text-gray-800">Add User</h4>
                  <p className="text-xs text-gray-600 mt-1">Create new user account</p>
                </div>
              </button>
            </div>
          </div>
